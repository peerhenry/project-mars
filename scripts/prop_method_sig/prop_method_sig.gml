/// @arg name
function prop_method_sig(argument0, argument1) {
	var name = argument0;
	var sig = argument1;
	...
	var meth_info = (scr_length(params) > 0) ? fnew(c_method_info, [return_type_info, params]) : fnew(c_method_info, return_type_info);
