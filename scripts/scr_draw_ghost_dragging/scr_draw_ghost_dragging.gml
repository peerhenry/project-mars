...
if(arg_build == build.wall)
{
	...
	if(arg_abs_diff_i > arg_abs_diff_j)
	{
		...
		scr_draw_tile_ghost(i_left, arg_origin_j, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_end, 180);
		scr_draw_tile_ghost(i_right, arg_origin_j, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_end, 0);
		for(var n = i_left + 1; n < i_right; n++)
		{
			scr_draw_tile_ghost(n, arg_origin_j, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_straight, 0);
		}
	}
	else
	{
		...
		scr_draw_tile_ghost(arg_origin_i, j_top, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_end, 90);
		scr_draw_tile_ghost(arg_origin_i, j_bottom, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_end, 270);
		for(var n = j_top + 1; n < j_bottom; n++)
		{
			scr_draw_tile_ghost(arg_origin_i, n, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_straight, 90);
		}
	}
}
	...
	for(var n = 0; n<tile_count; n++)
	{
		...
		if(di == 0)
		{
			if(dj == 0)
			{
				...
				for(var ni = 0; ni <= i_count; ni++)
				{
					...
					{
						scr_draw_tile_ghost(next_i, next_j, action_offset, action_count, arg_rotation, validation_alpha, noone, -1);
			...
			else if(dj == 1)
			{
				...
				for(var ni = 0; ni <= i_count; ni++)
				{
					scr_draw_tile_ghost(next_i, j_bottom, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_straight, 0);
					next_i = next_i + i_increment;
				}
			}
			else
			{
				...
				for(var ni = 0; ni <= i_count; ni++)
				{
					scr_draw_tile_ghost(next_i, j_top, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_straight, 0);
					next_i = next_i + i_increment;
				}
			}
		}
		else if(di == 1)
		{
			if(dj == 0)
			{
				...
				for(var nj = 0; nj <= j_count; nj++)
				{
					scr_draw_tile_ghost(i_right, next_j, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_straight, 90);
					next_j = next_j + j_increment;
				}
			}
			else if(dj == 1)
			{
				...
				scr_draw_tile_ghost(i_right, j_bottom, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_edge, 0);
			}
			else
			{
				// draw north-east edge
				scr_draw_tile_ghost(i_right, j_top, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_edge, 270);
			}
		}
		else
		{
			if(dj == 0)
			{
				...
				for(var nj = 0; nj <= j_count; nj++)
				{
					scr_draw_tile_ghost(i_left, next_j, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_straight, 90);
					next_j = next_j + j_increment;
				}
			}
			else if(dj == 1)
			{
				...
				scr_draw_tile_ghost(i_left, j_bottom, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_edge, 90);
			}
			else
			{
				// draw north-west edge
				scr_draw_tile_ghost(i_left, j_top, action_offset, action_count, arg_rotation, validation_alpha, spr_wall_edge, 180);
			}
		}
	}
}
