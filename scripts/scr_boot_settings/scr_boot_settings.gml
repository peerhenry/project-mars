...
function scr_boot_settings() {
	...
	settings[? key_settings_window_x] = init_global_real("window", "window_x", default_window_x);
	settings[? key_settings_window_y] = init_global_real("window", "window_y", default_window_y);
