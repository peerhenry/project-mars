...
function scr_update_ghost_tile_with_overrides(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	for(var m = 0; m < array_length_1d(arg_actions); m++)
	{
		...
		// validate
		// show_debug_message("now validating @i,j: " + string(target_i) + ", " + string(target_j)); // DEBUG
