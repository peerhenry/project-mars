function test_three_v_pipes_destroy_center() {
	test_init(test_three_v_pipes_destroy_center);

	// arrange
	var cable1 = instance_create_depth(48,48,0,obj_pipe);
	var cable2 = instance_create_depth(48,80,0,obj_pipe);
	var cable3 = instance_create_depth(48,112,0,obj_pipe);
