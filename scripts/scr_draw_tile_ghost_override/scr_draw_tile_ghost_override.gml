/// overrides the sprite and angle
...
var arg_sprite = argument6;
var arg_angle = argument7;
...
if(!there_is_a_valid_nondrawable && there_is_a_drawable)
{
	...
	if(sprite_for_ghost >= 0){
		draw_sprite_ext( sprite_for_ghost, b_image_index, target_x, target_y, 1, 1, arg_angle, c_white, validation_alpha );
