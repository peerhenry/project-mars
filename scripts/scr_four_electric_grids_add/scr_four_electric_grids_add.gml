...
switch(equality_number)
{
	...
	case 5:
		var joined_grid = scr_electric_grid_join(arg_grid_1, arg_grid_3);
	...
	case 3:
		var joined_grid = scr_electric_grid_join(arg_grid_1, arg_grid_4);
		scr_electric_grid_add(joined_grid, arg_instance);
		return joined_grid;
	case 6:
		var joined_grid = scr_electric_grid_join(arg_grid_1, arg_grid_2);
	...
	case 1:	// G1 = G2
	case 2:	// G2 = G3
		var joined_grid = scr_electric_grid_join_3(arg_grid_1, arg_grid_2, arg_grid_4);
		scr_electric_grid_add(joined_grid, arg_instance);
		return joined_grid;
	case 4: // G3 = G4
	case 8: // G4 = G1
		var joined_grid = scr_electric_grid_join_3(arg_grid_1, arg_grid_2, arg_grid_3);
		scr_electric_grid_add(joined_grid, arg_instance);
		return joined_grid;
}
...
var joined_grid = scr_electric_grid_join_4(arg_grid_1, arg_grid_2, arg_grid_3, arg_grid_4);
scr_electric_grid_add(joined_grid, arg_instance);
return joined_grid;