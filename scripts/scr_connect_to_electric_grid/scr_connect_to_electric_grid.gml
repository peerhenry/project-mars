...
switch(grid_adj_number)
{
	...
	case 3:	// E+N
		return scr_two_electric_grids_add(arg_instance, grid_east, grid_north);
	case 5:	// E+W
		return scr_two_electric_grids_add(arg_instance, grid_east, grid_west);
	case 9: // E+S
		return scr_two_electric_grids_add(arg_instance, grid_east, grid_south);
	case 6: // N+W
		return scr_two_electric_grids_add(arg_instance, grid_north, grid_west);
	case 10: // N+S
		return scr_two_electric_grids_add(arg_instance, grid_north, grid_south);
	case 12: // W+S
		return scr_two_electric_grids_add(arg_instance, grid_west, grid_south);
	// three grids found
	case 7:	// ENW
		return scr_three_electric_grids_add(arg_instance, grid_east, grid_north, grid_west);
	case 11: // ENS
		return scr_three_electric_grids_add(arg_instance, grid_east, grid_north, grid_south);
	case 13: // EWS
		return scr_three_electric_grids_add(arg_instance, grid_east, grid_west, grid_south);
	case 14: // NWS
		return scr_three_electric_grids_add(arg_instance, grid_north, grid_west, grid_south);
	// four grids
	case 15:
		return scr_four_electric_grids_add(arg_instance, grid_east, grid_north, grid_west, grid_south);
}
