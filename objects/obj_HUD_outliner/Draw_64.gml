...
draw_text(text_left, tab_astro_top + text_y_offset, "astronauts");
...
draw_set_color(c_white);
draw_text(text_left, tab_robot_top + text_y_offset, "robots");
...
draw_set_color(c_white);
draw_text(text_left, tab_cart_top + text_y_offset, "carts");