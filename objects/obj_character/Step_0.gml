...
var sprite_walk_down = spr_character_walk_down;
var sprite_walk_right = spr_character_walk_right;
var sprite_walk_up = spr_character_walk_up;
if(!wears_suit){
	var sprite_walk_down = spr_character_suitless_down;
	var sprite_walk_right = spr_character_suitless_right;
	var sprite_walk_up = spr_character_suitless_up;
}
