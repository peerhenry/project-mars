...
// grid production
var c1 = instance_create_depth(id, 0, 0, dto_gui_container_autosize);
with(c1)
{
	padding = 16;
	spacing = 8;
...
var c2 = instance_create_depth(id, 0, 0, dto_gui_container_autosize);
with(c2)
{
	padding = 16;
	spacing = 8;
...
// grid demand
var c3 = instance_create_depth(id, 0, 0, dto_gui_container_autosize);
with(c3)
{
	padding = 16;
	spacing = 8;
